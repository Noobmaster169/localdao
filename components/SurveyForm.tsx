      ...
      <Form {...form}>
            ...
            >
                          ...
                          <button
                            ...
                            <div className="h-full flex flex-wrap gap-y-4 gap-x-2 w-fit">
                              {options.map((option, index) => {
                                return (
                                  <div key={index} className="line-clamp-2 flex max-w-[450px] h-full bg-black bg-opacity-40 drop-shadow-lg rounded-lg p-2 border border-p1">
              ...
              <Button
                ...
                shadow-[0_0_30px_#40A4FF] drop-shadow-xl ${isBuilding || isUploading ? "opacity-50 pointer-events-none" : "opacity-100"} hover:bg-opacity-100 flex gap-2`}
                type="submit"
                >
                  {isBuilding || isUploading ? "Uploading" : "Create"}
                  {isBuilding || isUploading ? <div className="animate-spin">
                  <CgSpinner />
                  </div> : ""}
              </Button>
